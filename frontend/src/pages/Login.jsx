...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Manager roles go straight to the admin panel — they don't see the storefront
      const target = ['admin', 'sales_manager', 'product_manager'].includes(data.user?.role) ? '/admin' : redirectTo;
