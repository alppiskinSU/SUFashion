    ...
    <footer className="bg-surface-container-low w-full py-20 px-12 border-t-0">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col gap-4">
          <h4 className="font-sans text-xs uppercase tracking-widest font-bold text-primary mb-2">Pages</h4>
          ...
          <Link to="/collections" className="font-sans text-xs uppercase tracking-widest font-medium text-outline hover:text-primary transition-colors duration-300">Collections</Link>
          <Link to="/about" className="font-sans text-xs uppercase tracking-widest font-medium text-outline hover:text-primary transition-colors duration-300">About</Link>
          <Link to="/contact" className="font-sans text-xs uppercase tracking-widest font-medium text-outline hover:text-primary transition-colors duration-300">Contact</Link>
        </div>
      ...
      <div className="max-w-7xl mx-auto mt-24 border-t border-outline-variant pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
        <span className="font-sans text-[10px] uppercase tracking-[0.2em] text-outline">© 2026 SUFASHION ATELIER. ALL RIGHTS RESERVED.</span>
